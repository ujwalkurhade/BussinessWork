...
function Footer() {
  return (
    <div class="w-[100%] h-[268px] relative mt-2">
      <div className="flex ">
      ...
      <div class="w-[100%] left-0 top-[214px]  border border-neutral-300"></div>
      <div class="left-[588px] mt-[24px]  text-stone-500 text-[13px] font-normal leading-normal text-center">
