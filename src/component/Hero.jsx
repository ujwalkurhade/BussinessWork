...
import laptop from "../component/BillSittingusinglaptop1.png";
import Ellipse1 from "../component/Ellipse1.png";
import Ellipse2 from "../component/Ellipse2.png";
import Cuboid1 from "../component/Cuboid1.png";
import BigPlant1 from "../component/BigPlant1.png";
import Succlentangle1 from "../component/Succlentangle1.png";
  ...
  return (
    <div className=" w-[100%] h-[100%] p-[40px] bg-[#1090CB1A] border-2  flex justify-between items-center overflow-hidden ">
      ...
      <div className="mt-[-10rem] relative mr-[5rem]">
        ...
        <div class="w-[66px] h-[66px] absolute mt-[-30rem]">
          <img src={Succlentangle1} />
        </div>

        {/*  */}
        <div class="w-[185px] h-[185px] mt-[-15rem] ml-[22rem] z-10 absolute">
          <img src={BigPlant1} />
        </div>
      </div>
    </div>
